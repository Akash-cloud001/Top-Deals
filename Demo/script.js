// const productSection = document.getElementById('ebayDeals');
const productSection = $("#ebayDeals");
const loader = $('#loader');
...
// productSection.addEventListener('onscroll', ()=>{
//     console.log(hi);
// })
